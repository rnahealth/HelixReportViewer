        ...
        static public OleDbConnection GetConnection()
        {
            ...
            //while (counter < 10)
            {
                ...
                try
                {
                    ...
                    Cn = new OleDbConnection(@"Provider=OraOLEDB.Oracle;user id=RNAPGM;data source=" + MainForm.dbName + ";password=rna_rna_202;Persist Security Info=True;pooling=false");
